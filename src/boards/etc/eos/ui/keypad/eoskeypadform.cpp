...
EosKeypadForm::EosKeypadForm(EosForm *eosForm, QWidget *parent) :
	...
	setupActionButton(ui->keyBlind, eosForm->board->keyActionBlind);
	...
	setupActionButton(ui->keyData, eosForm->board->keyActionData);
	...
	setupActionButton(ui->keyDisplayTiming, eosForm->board->keyActionDisplayTiming);
	setupActionButton(ui->keyDisplays, eosForm->board->keyActionDisplays);
	setupActionButton(ui->keyEffect, eosForm->board->keyActionEffect);
	setupActionButton(ui->keyEnter, eosForm->board->keyActionEnter);
	setupActionButton(ui->keyEscape, eosForm->board->keyActionEscape);
	setupActionButton(ui->keyExpand, eosForm->board->keyActionExpand);
	setupActionButton(ui->keyFader, eosForm->board->keyActionFader);
	setupActionButton(ui->keyFan, eosForm->board->keyActionFan);
	setupActionButton(ui->keyFlexichannelMode, eosForm->board->keyActionFlexichannelMode);
	setupActionButton(ui->keyFocusPalette, eosForm->board->keyActionFocusPalette);
	setupActionButton(ui->keyFormat, eosForm->board->keyActionFormat);
	...
	setupActionButton(ui->keyLive, eosForm->board->keyActionLive);
	...
	setupActionButton(ui->keyMoreSoftkeys, eosForm->board->keyActionMoreSoftkeys);
	...
	setupActionButton(ui->keyPageDown, eosForm->board->keyActionPageDown);
	setupActionButton(ui->keyPageLeft, eosForm->board->keyActionPageLeft);
	setupActionButton(ui->keyPageRight, eosForm->board->keyActionPageRight);
	setupActionButton(ui->keyPageUp, eosForm->board->keyActionPageUp);
	...
	setupActionButton(ui->keyScrollLock, eosForm->board->keyActionScrollLock);
	setupActionButton(ui->keySelect, eosForm->board->keyActionSelect);
	...
	setupActionButton(ui->keySetup, eosForm->board->keyActionSetup);
	...
	setupActionButton(ui->keyStage, eosForm->board->keyActionStage);
	setupActionButton(ui->keySub, eosForm->board->keyActionSub);
	setupActionButton(ui->keyTab, eosForm->board->keyActionTab);
	...
	setupActionButton(ui->keyUndo, eosForm->board->keyActionUndo);
